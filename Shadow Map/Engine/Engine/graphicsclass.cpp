...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_CubeModel->Initialize(m_D3D->GetDevice(), L"../Engine/cube.txt", L"../Engine/paper.dds");
	if(!result)
	{
	...
	result = m_SphereModel->Initialize(m_D3D->GetDevice(), L"../Engine/sphere.txt", L"../Engine/marble.dds");
	if(!result)
	{
	...
	result = m_GroundModel->Initialize(m_D3D->GetDevice(), L"../Engine/plane01.txt", L"../Engine/checkerboard.dds");
	if(!result)
	{
